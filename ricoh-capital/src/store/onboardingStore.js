...
export const useOnboardingStore = create(
  persist(
    (set, get) => ({
      ...
      documents: {
        certificate_of_incorporation: { status: 'pending', fileName: null, fileSize: null, mimeType: null, filePath: null, failureReason: null },
        proof_of_address:             { status: 'pending', fileName: null, fileSize: null, mimeType: null, filePath: null, failureReason: null },
        bank_statements:              { status: 'pending', fileName: null, fileSize: null, mimeType: null, filePath: null, failureReason: null },
        director_photo_id:            { status: 'pending', fileName: null, fileSize: null, mimeType: null, filePath: null, failureReason: null },
        aml_kyc_policy:               { status: 'pending', fileName: null, fileSize: null, mimeType: null, filePath: null, failureReason: null },
        pi_insurance:                 { status: 'pending', fileName: null, fileSize: null, mimeType: null, filePath: null, failureReason: null },
      },
      applicationId: null,
      uploadProgress: {},
